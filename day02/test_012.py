...
# 接口地址http://www.zhifu.com/pay
# 方法：post
# 参数：{"订单号":1232,"支付金额":124,"支付方式":"余额宝"}
...
def test_zhifu():
    data = {"订单号":1232,"支付金额":124,"支付方式":"余额宝"}
    # return_value是参数
...
# 模块名.方法名
# 模块名.类名.方法名
@mock.patch("day02.test_012.zhifu",return_value ={"code":10001,"msg":"支付成功"})
